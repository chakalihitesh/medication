...
def generate_ai_response(user_message, chat_history=[], language="english"):
    """
    ...
    if emergency_check["is_emergency"]:
        ...
        database.save_chat_message("assistant", db_response)
        return {
            "text": db_response,
            "is_emergency": True,
    ...
    if not api_key:
        ...
        database.save_chat_message("assistant", mock_response)
        return {
            "text": mock_response,
            "is_emergency": False,
            "hospitals": []
    ...
    try:
        ...
        database.save_chat_message("assistant", assistant_text)
        ...
        database.save_chat_message("assistant", error_fallback)
        return {
            "text": error_fallback,
            "is_emergency": False,
            "hospitals": []
