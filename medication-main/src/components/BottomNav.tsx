...
export function BottomNav({ currentScreen, setScreen }: BottomNavProps) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full z-50 flex justify-around items-center px-2 pt-2 pb-6 bg-surface-container-lowest shadow-[0_-4px_12px_rgba(0,104,122,0.05)] rounded-t-xl border-t border-surface-variant/50">
